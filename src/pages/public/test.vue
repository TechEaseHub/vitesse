    ...
    <div>
      <figure class="max-w-sm inline-block">
        <img
          ...
          class="leading-none mb-4 align-middle rounded-lg h-auto max-w-full shadow-lg"
          alt="Hollywood Sign on The Hill"
        >
        <figcaption class="text-sm text-neutral-600 text-right dark:text-neutral-400">
          A caption for the above image.
        </figcaption>
      </figure>

      <div class="flex">
        <div class="border rounded-lg bg-white flex overflow-hidden divide-x dark:border-gray-700 dark:bg-gray-900 rtl:flex-row-reverse dark:divide-gray-700">
          <button class="text-sm text-gray-600 font-medium px-4 py-2 cursor-pointer transition-colors duration-200 sm:text-base dark:text-gray-300 sm:px-6 hover:bg-gray-100 dark:hover:bg-gray-800">
            Upload
          </button>
        ...
        <div class="border rounded-lg bg-white flex overflow-hidden divide-x dark:border-gray-700 dark:bg-gray-900 rtl:flex-row-reverse dark:divide-gray-700">
          <button class="text-sm text-gray-600 font-medium px-4 py-2 flex gap-x-3 cursor-pointer transition-colors duration-200 items-center sm:text-base dark:text-gray-300 sm:px-6 hover:bg-gray-100 dark:hover:bg-gray-800">
        ...
        <div class="flex gap-3 items-center sm:gap-x-5">
          <button class="px-8 py-2.5 border rounded-lg bg-white transition-colors duration-300 dark:border-gray-700 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800">
          ...
          <button class="px-8 py-2.5 border border-transparent rounded-lg bg-[#1877F2] transition-colors duration-300 hover:bg-[#1877F2]/80">
            <svg class="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button class="px-8 py-2.5 border border-transparent rounded-lg bg-black transition-colors duration-300 hover:bg-black/80">
            <svg class="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
